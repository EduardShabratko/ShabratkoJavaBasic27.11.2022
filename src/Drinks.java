...
public class Drinks {
    public static final int COFFEE_PRICE = 10;

    public static final int TEA_PRICE = 15;

    public static final int LEMONADE_PRICE = 20;

    public static final int MOCHITO_PRICE = 25;

    public static final int MINERAL_WATER_PRICE = 22;

    public static final int COCA_COLA_PRICE = 30;
